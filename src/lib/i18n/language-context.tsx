...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "hero.badge": "POWERED BY 1,700+ FAILED STARTUPS",
    "hero.title1": "Before You Quit Your Job,",
    "hero.title2": "Let 1,700+ Dead Startups",
    ...
    "how.step2.desc": "AI cross-references your idea against 1,700+ failure patterns in under 30 seconds.",
    ...
    "analyze.subtitle": "Describe your idea below. Our AI will cross-reference it against 1,700+ failed startups and give you an honest assessment.",
    ...
    "analyze.streaming.subtitle": "Analyzing your idea against 1,700+ failure patterns...",
    ...
    "dashboard.subtitle": "Explore 1,700+ failed startups. Filter by industry, death cause, or search.",
  ...
  zh: {
    ...
    "nav.dashboard": "数据库",
    "nav.scan": "分析我的想法 →",
    "hero.badge": "基于 1,700+ 失败案例的数据洞察",
    "hero.title1": "在你辞职之前，",
    "hero.title2": "先让 1,700+ 个失败案例",
    "hero.title3": "审查你的想法。",
    ...
    "how.step2.desc": "AI 在 30 秒内将你的想法与 1,700+ 失败模式交叉比对。",
    ...
    "analyze.subtitle": "在下面描述你的想法。AI 将它与 1,700+ 个失败案例交叉比对，给你一个诚实的评估。",
    ...
    "analyze.streaming.subtitle": "正在将你的想法与 1,700+ 失败模式进行比对...",
    ...
    "dashboard.subtitle": "探索 1,700+ 失败案例。按行业、死因筛选或搜索特定公司。从历史中学习，避免重蹈覆辙。",
